...
Create a webpage; the background should be a slideshow that cycles through five different images. This background should change every three seconds. (I recommend using images hosted on Imgur.com.)
...
**Make it so** that the image changes on its own every five seconds or so.
